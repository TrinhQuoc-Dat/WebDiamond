...
export default function Header() {
  const { contacts, resetAllData, logout } = useAdminData();
        ...
        <div className="relative">
          ...
          {showProfileMenu && (
            ...
            >
              ...
              <button
                onClick={handleReset}
                className="w-full text-left flex items-center gap-2 text-gray-400 hover:text-white hover:bg-white/[0.02] transition-colors border-t border-[#1C1C1E]"
                style={{ padding: '10px 16px' }}
              >
                <svg fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-4 h-4">
                  <path strokeLinecap="round" strokeLinejoin="round" d="M16.023 9.348h4.992v-.001M2.985 19.644v-4.992m0 0h4.992m-4.993 0l3.181 3.183a8.25 8.25 0 0013.803-3.7M4.031 9.865a8.25 8.25 0 0113.803-3.7l3.181 3.182m0-4.991v4.99" />
              ...
              <button
                ...
                className="w-full text-left flex items-center gap-2 text-red-400 hover:text-red-300 hover:bg-red-500/[0.03] transition-colors border-t border-[#1C1C1E]"
                style={{ padding: '10px 16px' }}
              >
                <svg fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-4 h-4">
