  ...
  return (
    <footer className="w-full bg-white text-black border-t border-gray-200">
      <div className="w-full flex flex-col items-center" style={{ paddingLeft: "5%", paddingRight: "5%" }}>
        <div className="max-w-[1440px] w-full mx-auto min-h-[240px] px-4 md:px-8 flex flex-col md:flex-row items-center justify-between py-12 md:py-0">

        {/* ── Left Group: Logo/Socials + QR Code ── */}
        <div className="flex flex-col md:flex-row items-start gap-8 lg:gap-12 shrink-0">
        ...
        {/* ── Right Menu ── */}
        <div className="flex gap-8 lg:gap-16 text-center md:text-left shrink-0">
